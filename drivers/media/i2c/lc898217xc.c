...
/* Actuator has 12 bit resolution */
#define LC898217XC_MAX_FOCUS_POS (4096 - 1)
...
static int lc898217xc_init_controls(struct lc898217xc *lc898217xc)
{
	...
	lc898217xc->focus = v4l2_ctrl_new_std(hdl, ops, V4L2_CID_FOCUS_ABSOLUTE,
					      lc898217xc->focus_min_pos,
					      lc898217xc->focus_max_pos,
...
static int lc898217xc_probe(struct i2c_client *client)
{
	...
	lc898217xc->focus_max_pos = LC898217XC_MAX_FOCUS_POS;
	lc898217xc->focus_min_pos = LC898217XC_MIN_FOCUS_POS;
...
MODULE_AUTHOR("Vasiliy Doylov <nekodevelopper@gmail.com>");
MODULE_DESCRIPTION("LC898217XC VCM driver");
